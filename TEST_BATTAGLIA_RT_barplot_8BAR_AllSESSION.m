...
%% RT barplot all session mean for single dir 
par.RTbarplotSingleDir.num_dir = num_dir;
par.RTbarplotSingleDir.max_y = max_y;
par.RTbarplotSingleDir.idcond = idcond;
par.RTbarplotSingleDir.dir_path = dir_path;
RTbarplotSingleDir(RT_plotMean,RT_plotStd,par.RTbarplotSingleDir)
