...
for cd=1:num_cond
    for ndir = 1:num_dir
       ...
       text(0.95, 0.9, textString, 'Units', 'normalized', ...
        ...
        VelocityGradient_path = strcat(dir_path,'VelocityGradient\',num2str(windowSize),'wind\');
...
for cd=1:num_cond
    for ndir = 1:num_dir
        ...
        par.filtJXY.Fc=30;
        if strcmp(smooth,'SG')
            MK_smoothSG = filtJXY(MK_smoothSG,par.filtJXY);
            MS_smoothSG = filtJXY(MS_smoothSG,par.filtJXY);
            % figure
        ...
        VelocitySmooth_path = strcat(dir_path,'VelocitySmooth\',num2str(windowSize),'wind\');
